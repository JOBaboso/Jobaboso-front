...
온보딩은 단순한 교육이 아니라, '부산다이나믹스의 한 구성원'으로 거듭나는 과정입니다.`,
    ...
    description: '부산다이나믹스의 신입 개발자 온보딩 프로그램과 첫 한 달의 성장 과정을 소개합니다.',
    author: '부산다이나믹스',
    date: '2025. 6. 10.',
    time: '11:00',
    tags: ['#온보딩', '#신입개발자', '#성장'],
...
작은 실험이 큰 변화를 만들 수 있다는 걸 직접 경험한 순간이었습니다.`,
    ...
    description: '부산다이나믹스 IoT 팀의 에너지 절약 프로젝트와 스마트홈 솔루션 개발 과정을 다룹니다.',
    author: '부산다이나믹스',
    date: '2025. 6. 4.',
    time: '15:00',
...
결국 부산다이나믹스의 성장으로 이어진다는 것을요.`,
    ...
    description: '부산다이나믹스의 IT 인재 양성 프로그램과 지역 개발자 생태계 구축 노력을 다룹니다.',
    author: '부산다이나믹스',
    date: '2025. 6. 1.',
    time: '13:00',
    tags: ['#멘토링', '#IT교육', '#성장스토리'],
